...
import { getByTag } from "../services/fetch";
        ...
        <>
            <main className='bg-stone-900 text-white w-full p-4 font-bold'>
                <div className='max-w-2xl mx-auto p-6'>
                    <h1 className='text-3xl font-bold mb-6 text-center text-gray-800 dark:text-white'>Tags: {nombre}</h1>
                </div>
